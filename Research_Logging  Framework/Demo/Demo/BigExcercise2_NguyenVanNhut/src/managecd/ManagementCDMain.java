...
public class ManagementCDMain {
   static Logger logger1 = Logger.getLogger(ManagementCDMain.class);
    public static void main(String[] args) throws IOException, ClassNotFoundException, SQLException, SAXException, ParserConfigurationException {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 1: {
                    logger1.debug("Start show infor all list");
                    System.out.println("All category");
                    CdController p = new CdController();
                    List<Cd> list = p.viewCd(); 
                    showCd(list);
                    logger1.info("Stop show infor list");
                    logger1.info("all list:"+list);
                    break;
                }
                // add cd
                case 2: {
                    try {
                        logger1.info("Start add cd");
                        ...
                        logger1.info("add cd success");
                        logger1.info("stop add cd");
